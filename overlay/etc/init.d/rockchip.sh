...
install_mali() {
    case $1 in
        rk3288)
            dpkg -i /packages/libmali/libmali-midgard-t76x-r18p0-r0p0-x11_1.9-1_armhf.deb
            dpkg -i /packages/libmali/libmali-midgard-t76x-r18p0-r0p0-x11-dbgsym_1.9-1_armhf.deb
            ;;
        rk3399|rk3399pro)
            dpkg -i /packages/libmali/libmali-midgard-t86x-r18p0-x11_1.9-1_arm64.deb
            dpkg -i /packages/libmali/libmali-midgard-t86x-r18p0-x11-dbgsym_1.9-1_arm64.deb
            ;;
        rk3328)
